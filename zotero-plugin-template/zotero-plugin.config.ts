...
export default {
  ...
  updateURL: "https://raw.githubusercontent.com/GW19ddd/PaperFlow/main/updates.json",
  xpiDownloadLink:
    "https://github.com/GW19ddd/PaperFlow/releases/download/v{{version}}/{{xpiName}}.xpi",
